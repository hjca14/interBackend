...
def test_device_display_name_round_trips() -> None:
    device = _device(display_name="Minha casa")
    assert device.display_name == "Minha casa"
    assert device.to_item()["display_name"] == "Minha casa"


def test_device_display_name_is_trimmed_and_accepts_unicode() -> None:
    device = _device(display_name="  Casa da Vovó 🏠  ")
    assert device.display_name == "Casa da Vovó 🏠"
